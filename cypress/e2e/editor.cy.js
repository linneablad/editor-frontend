describe("Test editor-app", () => {
  it(`Loginpage should contain an h1 with text Login,
      a label with text Email, a label with text Password,  
      a button with text Login,
      and a button with text Register`, () => {
    cy.visit("/");
